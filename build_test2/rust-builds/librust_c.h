...
#define BUILD_CYBERPUNK
#define BUILD_MULTI_COINS
#define FEATURE_APTOS
#define FEATURE_ARWEAVE
#define FEATURE_BCH
#define FEATURE_BITCOIN
#define FEATURE_CARDANO
#define FEATURE_COSMOS
#define FEATURE_DASH
#define FEATURE_ETHEREUM
#define FEATURE_LTC
#define FEATURE_DOGE
#define FEATURE_SOLANA
#define FEATURE_STELLAR
#define FEATURE_TON
#define FEATURE_TRON
#define FEATURE_XRP
#define FEATURE_AVAX
#define FEATURE_IOTA
#define FEATURE_ZCASH
#define FEATURE_MONERO


#define FRAGMENT_MAX_LENGTH_DEFAULT 200

#define FRAGMENT_UNLIMITED_LENGTH 11000
 ...
 */
typedef struct DeriveContextHashCallData {
  PtrString app_name;
  PtrString network;
  PtrString key_path;
  PtrString context;
  PtrString origin;
} DeriveContextHashCallData;

typedef struct Response_DeriveContextHashCallData {
  struct DeriveContextHashCallData *data;
  uint32_t error_code;
  PtrString error_message;
} Response_DeriveContextHashCallData;

typedef struct Response_DeriveContextHashCallData *PtrT_Response_DeriveContextHashCallData;
...
typedef struct DisplayAvaxMethodInfo {
  PtrString method_key;
  PtrString method;
  int64_t start_time;
  int64_t end_time;
} DisplayAvaxMethodInfo;

typedef struct DisplayAvaxMethodInfo *PtrT_DisplayAvaxMethodInfo;

typedef struct DisplayAvaxFromToInfo {
  PtrString address;
  PtrString amount;
  PtrString path;
  bool is_change;
...
typedef struct DisplayAvaxFromToInfo *PtrT_DisplayAvaxFromToInfo;

typedef struct VecFFI_DisplayAvaxFromToInfo {
  PtrT_DisplayAvaxFromToInfo data;
  size_t size;
  size_t cap;
} VecFFI_DisplayAvaxFromToInfo;

typedef struct VecFFI_DisplayAvaxFromToInfo *PtrT_VecFFI_DisplayAvaxFromToInfo;

typedef struct DisplayTxAvaxData {
  PtrString network;
  PtrString network_key;
  PtrString subnet_id;
  PtrString total_output_amount;
  PtrString total_input_amount;
  PtrString fee_amount;
  PtrString reward_address;
  PtrString amount;
  PtrT_DisplayAvaxMethodInfo method;
  PtrT_VecFFI_DisplayAvaxFromToInfo to;
  PtrT_VecFFI_DisplayAvaxFromToInfo from;
} DisplayTxAvaxData;

typedef struct DisplayAvaxTx {
  struct DisplayTxAvaxData *data;
} DisplayAvaxTx;

typedef struct TransactionParseResult_DisplayAvaxTx {
  struct DisplayAvaxTx *data;
  uint32_t error_code;
  PtrString error_message;
} TransactionParseResult_DisplayAvaxTx;

typedef struct TransactionParseResult_DisplayAvaxTx *PtrT_TransactionParseResult_DisplayAvaxTx;

typedef struct DisplayIotaIntentData {
  PtrString amount;
  PtrString network;
  PtrString sender;
  PtrString recipient;
  ...
  PtrString message;
  PtrString to;
} DisplayIotaIntentData;

typedef struct TransactionParseResult_DisplayIotaIntentData {
  struct DisplayIotaIntentData *data;
  uint32_t error_code;
  PtrString error_message;
} TransactionParseResult_DisplayIotaIntentData;

typedef struct TransactionParseResult_DisplayIotaIntentData *PtrT_TransactionParseResult_DisplayIotaIntentData;

typedef struct DisplayIotaSignMessageHash {
  PtrString network;
  PtrString path;
  PtrString from_address;
  PtrString message;
} DisplayIotaSignMessageHash;

typedef struct TransactionParseResult_DisplayIotaSignMessageHash {
  struct DisplayIotaSignMessageHash *data;
  uint32_t error_code;
  PtrString error_message;
} TransactionParseResult_DisplayIotaSignMessageHash;

typedef struct TransactionParseResult_DisplayIotaSignMessageHash *PtrT_TransactionParseResult_DisplayIotaSignMessageHash;
...
typedef struct DisplayTxOverview {
  ...
  bool need_sign;
  bool has_witness_only_inputs;
  bool fee_is_lower_bound;
  bool fee_is_unknown;
  PtrString sighash_type;
  bool is_sighash_single;
  bool is_sighash_none;
} DisplayTxOverview;
...
typedef struct Response_MultiSigWallet *PtrT_Response_MultiSigWallet;
...
typedef struct DisplayETH *PtrT_DisplayETH;

typedef struct VecFFI_DisplayETH {
  PtrT_DisplayETH data;
  size_t size;
  size_t cap;
} VecFFI_DisplayETH;

typedef struct VecFFI_DisplayETH *PtrT_VecFFI_DisplayETH;

typedef struct DisplayETHBatchTx {
  PtrT_VecFFI_DisplayETH txs;
} DisplayETHBatchTx;

typedef struct TransactionParseResult_DisplayETHBatchTx {
  struct DisplayETHBatchTx *data;
  uint32_t error_code;
  PtrString error_message;
} TransactionParseResult_DisplayETHBatchTx;

typedef struct TransactionParseResult_DisplayETHBatchTx *PtrT_TransactionParseResult_DisplayETHBatchTx;
...
typedef struct DisplayETHTypedData {
  ...
  PtrString message;
  PtrString from;
  PtrString domain_hash;
  PtrString message_hash;
  PtrString safe_tx_hash;
} DisplayETHTypedData;
...
typedef struct EthParsedErc20Approval {
  PtrString spender;
  PtrString value;
} EthParsedErc20Approval;

typedef struct Response_EthParsedErc20Approval {
  struct EthParsedErc20Approval *data;
  uint32_t error_code;
  PtrString error_message;
} Response_EthParsedErc20Approval;

typedef struct Response_EthParsedErc20Approval *PtrT_Response_EthParsedErc20Approval;

typedef struct DisplayContractParam {
  PtrString name;
  PtrString value;
  PtrString param_type;
...
typedef struct DisplaySwapkitContractData {
  PtrString vault;
  PtrString swap_in_asset;
  PtrString swap_in_amount;
  PtrString swap_out_asset;
  PtrString swap_out_asset_contract_address;
  PtrString receive_address;
  PtrString expiration;
} DisplaySwapkitContractData;

typedef struct Response_DisplaySwapkitContractData {
  struct DisplaySwapkitContractData *data;
  uint32_t error_code;
  PtrString error_message;
} Response_DisplaySwapkitContractData;

typedef struct Response_DisplaySwapkitContractData *Ptr_Response_DisplaySwapkitContractData;

typedef struct Response_DisplayContractData *PtrT_Response_DisplayContractData;

typedef struct Response_DisplaySwapkitContractData *PtrT_Response_DisplaySwapkitContractData;

typedef struct DisplayMoneroOutput {
  PtrString txos_num;
  PtrString total_amount;
} DisplayMoneroOutput;

typedef struct TransactionParseResult_DisplayMoneroOutput {
  struct DisplayMoneroOutput *data;
  uint32_t error_code;
  PtrString error_message;
} TransactionParseResult_DisplayMoneroOutput;

typedef struct TransactionParseResult_DisplayMoneroOutput *PtrT_TransactionParseResult_DisplayMoneroOutput;

typedef struct DisplayMoneroUnsignedTxOutput {
  PtrString address;
  PtrString amount;
  bool is_change;
} DisplayMoneroUnsignedTxOutput;

typedef struct DisplayMoneroUnsignedTxOutput *PtrT_DisplayMoneroUnsignedTxOutput;

typedef struct VecFFI_DisplayMoneroUnsignedTxOutput {
  PtrT_DisplayMoneroUnsignedTxOutput data;
  size_t size;
  size_t cap;
} VecFFI_DisplayMoneroUnsignedTxOutput;

typedef struct VecFFI_DisplayMoneroUnsignedTxOutput *PtrT_VecFFI_DisplayMoneroUnsignedTxOutput;

typedef struct DisplayMoneroUnsignedTxInput {
  PtrString key;
  PtrString amount;
} DisplayMoneroUnsignedTxInput;

typedef struct DisplayMoneroUnsignedTxInput *PtrT_DisplayMoneroUnsignedTxInput;

typedef struct VecFFI_DisplayMoneroUnsignedTxInput {
  PtrT_DisplayMoneroUnsignedTxInput data;
  size_t size;
  size_t cap;
} VecFFI_DisplayMoneroUnsignedTxInput;

typedef struct VecFFI_DisplayMoneroUnsignedTxInput *PtrT_VecFFI_DisplayMoneroUnsignedTxInput;

typedef struct DisplayMoneroUnsignedTx {
  PtrT_VecFFI_DisplayMoneroUnsignedTxOutput outputs;
  PtrT_VecFFI_DisplayMoneroUnsignedTxInput inputs;
  PtrString input_amount;
  PtrString output_amount;
  PtrString fee;
} DisplayMoneroUnsignedTx;

typedef struct TransactionParseResult_DisplayMoneroUnsignedTx {
  struct DisplayMoneroUnsignedTx *data;
  uint32_t error_code;
  PtrString error_message;
} TransactionParseResult_DisplayMoneroUnsignedTx;

typedef struct TransactionParseResult_DisplayMoneroUnsignedTx *PtrT_TransactionParseResult_DisplayMoneroUnsignedTx;
...
typedef struct DisplayTonMessage {
  PtrString amount;
  PtrString action;
  PtrString to;
  PtrString comment;
...
typedef struct DisplayTonMessage *PtrT_DisplayTonMessage;

typedef struct VecFFI_DisplayTonMessage {
  PtrT_DisplayTonMessage data;
  size_t size;
  size_t cap;
} VecFFI_DisplayTonMessage;

typedef struct VecFFI_DisplayTonMessage *PtrT_VecFFI_DisplayTonMessage;

typedef struct DisplayTonTransaction {
  PtrString raw_data;
  PtrT_VecFFI_DisplayTonMessage messages;
...
typedef struct DisplayTRONPersonalMessage {
  PtrString raw_message;
  PtrString utf8_message;
  PtrString from;
} DisplayTRONPersonalMessage;

typedef struct TransactionParseResult_DisplayTRONPersonalMessage {
  struct DisplayTRONPersonalMessage *data;
  uint32_t error_code;
  PtrString error_message;
} TransactionParseResult_DisplayTRONPersonalMessage;

typedef struct TransactionParseResult_DisplayTRONPersonalMessage *PtrT_TransactionParseResult_DisplayTRONPersonalMessage;
...
struct SimpleResponse_c_char *format_value_with_decimals(PtrString value, uint32_t decimals);
...
struct UREncodeMultiResult *get_next_cyclic_part(PtrEncoder ptr);
...
Ptr_UREncodeResult generate_common_crypto_multi_accounts_ur(PtrBytes master_fingerprint,
                                                            uint32_t master_fingerprint_length,
                                                            Ptr_CSliceFFI_ExtendedPublicKey public_keys,
                                                            PtrString account_prefix);

struct UREncodeResult *generate_btc_crypto_account_ur(uint8_t *master_fingerprint,
                                                      uint32_t length,
                                                      PtrT_CSliceFFI_ExtendedPublicKey public_keys);

void free_Response_DeriveContextHashCallData(PtrT_Response_DeriveContextHashCallData ptr);
 ...
 */
PtrT_Response_DeriveContextHashCallData parse_derive_context_hash(PtrUR ur);
 ...
 */
PtrT_UREncodeResult generate_derive_context_hash_ur(PtrUR ur,
                                                    PtrBytes seed,
                                                    uint32_t seed_len,
                                                    PtrString displayed_address);

struct UREncodeResult *get_connect_cake_wallet_ur(PtrString pub_spend_key,
                                                  PtrString private_view_key);

struct UREncodeResult *get_connect_cake_wallet_ur_encrypted(PtrString pub_spend_key,
                                                            PtrString private_view_key,
                                                            PtrBytes pincode);
...
Ptr_UREncodeResult get_keystone_connect_wallet_ur(PtrBytes master_fingerprint,
                                                  uint32_t master_fingerprint_length,
                                                  PtrString serial_number,
                                                  Ptr_CSliceFFI_ExtendedPublicKey public_keys,
                                                  PtrString device_type,
...
Ptr_UREncodeResult get_core_wallet_ur(PtrBytes master_fingerprint,
                                      uint32_t master_fingerprint_length,
                                      Ptr_CSliceFFI_ExtendedPublicKey public_keys,
                                      PtrString device_type);
...
PtrT_TransactionParseResult_DisplayAvaxTx avax_parse_transaction(PtrUR ptr,
                                                                 PtrBytes mfp,
                                                                 uint32_t mfp_len,
                                                                 PtrT_CSliceFFI_ExtendedPublicKey public_keys);

PtrT_UREncodeResult avax_sign(PtrUR ptr, PtrBytes seed, uint32_t seed_len);

PtrT_UREncodeResult avax_sign_unlimited(PtrUR ptr, PtrBytes seed, uint32_t seed_len);

PtrT_TransactionCheckResult avax_check_transaction(PtrUR ptr, PtrBytes mfp, uint32_t mfp_len);

struct SimpleResponse_c_char *avalanche_get_x_p_address(PtrString hd_path,
                                                        PtrString root_x_pub,
                                                        PtrString root_path);

void free_TransactionParseResult_DisplayAvaxTx(PtrT_TransactionParseResult_DisplayAvaxTx ptr);

struct SimpleResponse_c_char *iota_get_address_from_pubkey(PtrString xpub);

PtrT_TransactionParseResult_DisplayIotaIntentData iota_parse_intent(PtrUR ptr);

PtrT_TransactionParseResult_DisplayIotaSignMessageHash iota_parse_sign_message_hash(PtrUR ptr);

PtrT_UREncodeResult iota_sign_hash(PtrUR ptr, PtrBytes seed, uint32_t seed_len);

PtrT_UREncodeResult iota_sign_intent(PtrUR ptr, PtrBytes seed, uint32_t seed_len);

void free_TransactionParseResult_DisplayIotaSignMessageHash(PtrT_TransactionParseResult_DisplayIotaSignMessageHash ptr);

void free_TransactionParseResult_DisplayIotaIntentData(PtrT_TransactionParseResult_DisplayIotaIntentData ptr);

struct SimpleResponse_c_char *utxo_get_address(PtrString hd_path, PtrString x_pub);

struct SimpleResponse_c_char *btcoin_get_address_with_network(PtrString hd_path,
                                                              PtrString x_pub,
                                                              PtrString network);
...
bool check_multi_sig_wallet_exist(PtrString content,
                                  PtrBytes master_fingerprint,
                                  uint32_t master_fingerprint_len);
...
void free_Response_MultiSigWallet(PtrT_Response_MultiSigWallet ptr);
...
struct TransactionParseResult_DisplayTx *utxo_parse_extend_psbt(PtrUR ptr,
                                                                PtrT_CSliceFFI_ExtendedPublicKey public_keys,
                                                                PtrBytes master_fingerprint,
                                                                uint32_t length);

struct UREncodeResult *utxo_sign_psbt_extend(PtrUR ptr,
                                             PtrBytes seed,
                                             uint32_t seed_len,
                                             PtrBytes master_fingerprint,
                                             uint32_t master_fingerprint_len,
...
PtrT_TransactionCheckResult utxo_check_psbt_extend(PtrUR ptr,
                                                   PtrBytes master_fingerprint,
                                                   uint32_t length,
                                                   PtrT_CSliceFFI_ExtendedPublicKey public_keys,
                                                   PtrString verify_code,
...
Ptr_SimpleResponse_c_char cardano_get_sign_cip8_data_root_index(PtrUR ptr);

PtrT_TransactionCheckResult cardano_check_sign_data_path_type(PtrUR ptr, PtrString cardano_xpub);

PtrT_TransactionCheckResult cardano_check_sign_data_is_sign_opcert(PtrUR ptr);

PtrT_TransactionCheckResult cardano_check_sign_data(PtrUR ptr, PtrBytes master_fingerprint);

PtrT_TransactionCheckResult cardano_check_sign_cip8_data(PtrUR ptr, PtrBytes master_fingerprint);

PtrT_TransactionCheckResult cardano_check_sign_cip8_data_path_type(PtrUR ptr,
...
PtrT_TransactionParseResult_DisplayCardanoSignData cardano_parse_sign_cip8_data(PtrUR ptr);
...
PtrT_UREncodeResult cardano_sign_sign_cip8_data_with_ledger_bitbox02(PtrUR ptr,
                                                                     PtrString mnemonic,
                                                                     PtrString passphrase);
...
PtrT_UREncodeResult cardano_sign_sign_cip8_data(PtrUR ptr,
                                                PtrBytes entropy,
                                                uint32_t entropy_len,
                                                PtrString passphrase,
                                                bool is_slip39);
...
PtrT_UREncodeResult cardano_sign_tx_with_ledger_bitbox02_unlimited(PtrUR ptr,
                                                                   PtrBytes master_fingerprint,
                                                                   PtrString cardano_xpub,
                                                                   PtrString mnemonic,
                                                                   PtrString passphrase);
...
PtrT_UREncodeResult cardano_sign_tx_unlimited(PtrUR ptr,
                                              PtrBytes master_fingerprint,
                                              PtrString cardano_xpub,
                                              PtrBytes entropy,
                                              uint32_t entropy_len,
...
struct SimpleResponse_c_char *cardano_get_pubkey_by_slip23(PtrBytes entropy,
                                                           uint32_t entropy_len,
                                                           PtrString path);
...
PtrT_TransactionParseResult_DisplayETHBatchTx eth_check_then_parse_batch_tx(PtrUR ptr,
                                                                            PtrBytes master_fingerprint,
                                                                            uint32_t mfp_length,
                                                                            PtrString xpub);

PtrT_UREncodeResult eth_sign_batch_tx(PtrUR ptr, PtrBytes seed, uint32_t seed_len);
...
PtrT_Response_EthParsedErc20Approval eth_parse_erc20_approval(PtrString input, uint32_t decimal);

Ptr_Response_DisplayContractData eth_parse_contract_data(PtrString input_data,
                                                         PtrString contract_json);

Ptr_Response_DisplaySwapkitContractData eth_parse_swapkit_contract(PtrString input_data,
                                                                   PtrString contract_json);
...
void free_TransactionParseResult_DisplayETHBatchTx(PtrT_TransactionParseResult_DisplayETHBatchTx ptr);
...
void free_Response_EthParsedErc20Approval(PtrT_Response_EthParsedErc20Approval ptr);

void free_Response_DisplaySwapkitContractData(PtrT_Response_DisplaySwapkitContractData ptr);

struct SimpleResponse_c_char *monero_get_address(PtrString pub_spend_key,
                                                 PtrString private_view_key,
                                                 uint32_t major,
                                                 uint32_t minor,
                                                 bool is_subaddress);

PtrT_TransactionCheckResult monero_output_request_check(PtrUR ptr,
                                                        PtrBytes decrypt_key,
                                                        PtrString pvk);

PtrT_TransactionCheckResult monero_unsigned_request_check(PtrUR ptr,
                                                          PtrBytes decrypt_key,
                                                          PtrString pvk);

struct SimpleResponse_c_char *get_monero_pvk_by_seed(PtrBytes seed, uint32_t seed_len);

PtrT_TransactionParseResult_DisplayMoneroOutput monero_parse_output(PtrUR ptr,
                                                                    PtrBytes decrypt_key,
                                                                    PtrString pvk);

PtrT_TransactionParseResult_DisplayMoneroUnsignedTx monero_parse_unsigned_tx(PtrUR ptr,
                                                                             PtrBytes decrypt_key,
                                                                             PtrString pvk);

PtrT_UREncodeResult monero_generate_keyimage(PtrUR ptr,
                                             PtrBytes seed,
                                             uint32_t seed_len,
                                             uint32_t major);

PtrT_UREncodeResult monero_generate_signature(PtrUR ptr,
                                              PtrBytes seed,
                                              uint32_t seed_len,
                                              uint32_t major);

struct SimpleResponse_u8 *monero_generate_decrypt_key(PtrString pvk);

struct SimpleResponse_c_char *get_extended_monero_pubkeys_by_seed(PtrBytes seed,
                                                                  uint32_t seed_len,
                                                                  PtrString path);

void free_TransactionParseResult_DisplayMoneroOutput(PtrT_TransactionParseResult_DisplayMoneroOutput ptr);

void free_TransactionParseResult_DisplayMoneroUnsignedTx(PtrT_TransactionParseResult_DisplayMoneroUnsignedTx ptr);
...
PtrT_TransactionCheckResult tron_check_sign_request(PtrUR ptr,
                                                    PtrString x_pub,
                                                    PtrBytes master_fingerprint,
                                                    uint32_t length);

struct TransactionParseResult_DisplayTron *tron_parse_sign_request(PtrUR ptr);

struct UREncodeResult *tron_sign_request(PtrUR ptr,
                                         PtrBytes seed,
                                         uint32_t seed_len,
...
PtrT_TransactionParseResult_DisplayTRONPersonalMessage tron_parse_personal_message(PtrUR ptr,
                                                                                   PtrString xpub);

void free_TransactionParseResult_DisplayTron(PtrT_TransactionParseResult_DisplayTron ptr);

void free_TransactionParseResult_DisplayTRONPersonalMessage(PtrT_TransactionParseResult_DisplayTRONPersonalMessage ptr);
...
struct TransactionCheckResult *check_zcash_tx_cypherpunk(PtrUR tx,
                                                         PtrString ufvk,
                                                         PtrBytes seed_fingerprint,
                                                         uint32_t account_index,
                                                         bool disabled);

struct TransactionCheckResult *check_zcash_tx_multi_coins(PtrUR tx,
                                                          PtrString xpub,
                                                          PtrBytes seed_fingerprint,
                                                          uint32_t account_index,
                                                          bool disabled);

Ptr_TransactionParseResult_DisplayPczt parse_zcash_tx_cypherpunk(PtrUR tx,
                                                                 PtrString ufvk,
                                                                 PtrBytes seed_fingerprint);

Ptr_TransactionParseResult_DisplayPczt parse_zcash_tx_multi_coins(PtrUR tx,
                                                                  PtrBytes seed_fingerprint);
