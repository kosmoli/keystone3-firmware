...
typedef enum {
    ...
    SIG_LOCK_VIEW_UPDATE_PURPOSE,
    SIG_SHOW_LOADING_ANIMATION,
    SIG_RESET_UTXO_ADDRESS_INDEX,
    SIG_RESET_ETH_ADDRESS_INDEX,
    SIG_RESET_STANDARD_ADDRESS_INDEX,
    SIG_RESET_MULTI_ACCOUNTS_CACHE,
    SIG_LOCK_VIEW_BUTT,
