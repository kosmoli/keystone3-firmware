...
/* KOSMO_VERSION: these macros override web3 versions when both are active.
   When only CYPHERPUNK_VERSION is defined (without WEB3), the extra web3
   entries are harmless dead enum values. */
...
#define HOME_WALLET_STATE_SURPLUS          {HOME_WALLET_CARD_ETH, false, "ETH", true},     \
    ...
    {HOME_WALLET_CARD_TON, false, "TON", true},     \
    {HOME_WALLET_CARD_ZEC, true, "ZEC", true},     \
    ...
    {HOME_WALLET_CARD_BABYLON, false, "BBN", true},  \
    {HOME_WALLET_CARD_NEUTARO, false, "NEUTARO", true}, \
