...
static void OnApproveHandler(lv_event_t *e)
{
    ...
    if (strcmp("1", g_callData->version) == 0) {
        ...
        GuiAnimatingQRCodeInit(g_keyDerivationTileView.qrCode, ModelGenerateSyncUR, true, GuiKeyDerivationWidgetHandleURGenerate, NULL, GuiKeyDerivationWidgetHandleURUpdate);
...
static void OpenMoreHandler(lv_event_t *e)
{
    ...
    bool hasChangePath = g_hasAda && g_hardwareCallParamsCheckResult.isLegal && (KosmoApi_GetMnemonicType() == KOSMO_MNEMONIC_BIP39);
